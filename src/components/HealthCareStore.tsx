...
import { ArrowLeft, SlidersHorizontal, Heart, X } from 'lucide-react';
...
interface HealthCareStoreProps {
  products: Product[];
...
export function HealthCareStore({ products, onAddToCart, onProductClick, onBackToHome }: HealthCareStoreProps) {
  const categories = ['Vitamins', 'Supplements', 'Skincare', 'Equipment'];
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <motion.div 
        ...
        className="relative bg-gradient-to-br from-cyan-500 via-teal-600 to-emerald-600 text-white overflow-hidden"
      >
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-12 relative z-10">
          ...
          >
            ...
            <div>
              <div className="text-white/80 text-xs font-medium mb-1">Explore Our</div>
              <h1 className="text-3xl md:text-5xl font-bold">Health & Wellness</h1>
            </div>
          </motion.div>
          ...
          >
            Premium vitamins, supplements, skincare, and fitness products
          </motion.p>
              ...
              {selectedCategories.length > 0 && (
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Button
                    ...
                    className="text-cyan-600 hover:text-cyan-700 hover:bg-cyan-50 rounded-full"
                  >
                    Clear All
                  </Button>
                </motion.div>
            ...
            <div className="flex items-center gap-3 w-full lg:w-auto">
              ...
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="flex-1 lg:flex-none">
                <Button 
                  ...
                  className="w-full lg:w-auto bg-gradient-to-r from-cyan-600 to-teal-600 hover:from-cyan-700 hover:to-teal-700 text-white rounded-2xl h-12 shadow-lg shadow-cyan-500/30"
                >
                  <SlidersHorizontal className="w-5 h-5 mr-2" />
                  Filters
                  {selectedCategories.length > 0 && (
                    <Badge className="ml-2 bg-white text-cyan-700 hover:bg-white">
            ...
            >
              ...
              {(selectedCategories.length > 0 || priceRange[0] > 0 || priceRange[1] < 1000) && (
                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  <Button
                    className="w-full mt-8 bg-gradient-to-r from-cyan-600 to-teal-600 hover:from-cyan-700 hover:to-teal-700 text-white rounded-2xl h-12 shadow-lg shadow-cyan-500/30"
                    onClick={() => {
                      setSelectedCategories([]);
                      setPriceRange([0, 1000]);
                    }}
          ...
          <div className="lg:col-span-3">
            {filteredProducts.length > 0 ? (
              ...
              >
                ...
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Button
                    className="bg-gradient-to-r from-cyan-600 to-teal-600 hover:from-cyan-700 hover:to-teal-700 text-white rounded-2xl px-8 h-14 shadow-lg shadow-cyan-500/30"
                    onClick={() => {
                      setSelectedCategories([]);
                      setPriceRange([0, 1000]);
                    }}
            ...
            >
              <div className="p-6">
                ...
                <div className="sticky bottom-0 bg-white pt-6 mt-8 border-t">
                  <Button
                    className="w-full bg-gradient-to-r from-cyan-600 to-teal-600 hover:from-cyan-700 hover:to-teal-700 text-white rounded-2xl h-14 text-lg shadow-xl shadow-cyan-500/30"
                    onClick={() => setFilterOpen(false)}
                  >
